...
def main():
    ...
    .stMetric {
        ...
        box-shadow: 0 4px 8px rgba(255, 182, 193, 0.2) !important;
    }
    .stMetric > div {
        color: #333 !important;
    }
    ...
    with metric_cols[0]:
        st.markdown(f"""
        <div style="background-color:#FFE4E1; border-radius:12px; padding:15px; text-align:center; box-shadow:0 4px 8px rgba(255, 182, 193, 0.2);">
            <h3 style="margin:0; color:#FF69B4; font-size:14px;">Total Sales</h3>
            <p style="margin:0; color:#FF1493; font-size:24px; font-weight:bold;">${total_sales:,.2f}</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with metric_cols[1]:
        st.markdown(f"""
        <div style="background-color:#FFE4E1; border-radius:12px; padding:15px; text-align:center; box-shadow:0 4px 8px rgba(255, 182, 193, 0.2);">
            <h3 style="margin:0; color:#FF69B4; font-size:14px;">Avg. Order Value</h3>
            <p style="margin:0; color:#FF1493; font-size:24px; font-weight:bold;">${avg_order:,.2f}</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with metric_cols[2]:
        ...
        st.markdown(f"""
        <div style="background-color:#FFE4E1; border-radius:12px; padding:15px; text-align:center; box-shadow:0 4px 8px rgba(255, 182, 193, 0.2);">
            <h3 style="margin:0; color:#FF69B4; font-size:14px;">USA Orders</h3>
            <p style="margin:0; color:#FF1493; font-size:24px; font-weight:bold;">{usa_count:,}</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with metric_cols[3]:
        ...
        st.markdown(f"""
        <div style="background-color:#FFE4E1; border-radius:12px; padding:15px; text-align:center; box-shadow:0 4px 8px rgba(255, 182, 193, 0.2);">
            <h3 style="margin:0; color:#FF69B4; font-size:14px;">Canada Orders</h3>
            <p style="margin:0; color:#FF1493; font-size:24px; font-weight:bold;">{canada_count:,}</p>
        </div>
        """, unsafe_allow_html=True)
